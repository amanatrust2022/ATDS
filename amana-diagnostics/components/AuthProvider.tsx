      ...
      if (!prof) {
        try {
          const { data, error } = await supabase
            .from('profiles')
            .select('id, full_name, title, first_name, surname, last_name, signature_url, role, role_label, performance_commission_type, performance_commission_value, organization_id, email')
            .eq('id', userId)
            .maybeSingle();
