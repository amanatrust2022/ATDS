 ...
 * feature components (Phase 3). They describe what the technologist sees and
 * what reaches the database, and must keep passing across the split with
 * nothing changed but import paths.
 *
 * The result serialisers they used to cover now live in
 * `lib/store/labResults.test.ts`.
 *
